...
export async function GetAllPosts(Token, LastPostID, LastPostCreatedAt) {
  try {
    ...
    const result = await axios.get(`${APIURI}/api/v1/Posts/all`, {
      headers: {
        authorization: Token,
        'Content-Type': 'application/json',
      },
...
export const getPostById = async (token, postUID) => {
  try {
    ...
    const result = await axios.get(`${APIURI}/api/v1/Posts/${postUID}`, {
      headers: {
        authorization: token,
        'Content-Type': 'application/json',
      },
...
export const getPostsCreatedByFollowingUsers = async (
  ...
  try {
    const result = await axios.get(`${APIURI}/api/v1/posts/following`, {
      headers: {
        authorization: token,
        'Content-Type': 'application/json',
      },
...
export async function GetPostsCreatedByUserName(
  ...
  try {
    ...
    const result = await axios.get(`${APIURI}/api/v1/Posts/User/${UserName}`, {
      headers: {
        authorization: Token,
        'Content-Type': 'application/json',
      },
